...
# Local is just lexical scoping for a certain function, which is not useful
# for config. That is why all of these variables are global.
#
...
set --export --global YARN_BIN $HOME/.config/yarn/global/node_modules/.bin
